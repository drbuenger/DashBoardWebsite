                ...
                style_cell_conditional=[{'if': {'row_index': 'odd'}, 'backgroundColor': '#D5DBDB'}]
                                       ...
                                       + [{'if': {'column_id': c}, 'minWidth': '0px', 'maxWidth': '80px',
                                          ...
                                          ['Spend TY', 'Spend - LP', 'Spend PoP (Abs)', 'Spend PoP (%)', 'Spend LY',
                                           ...
                                           'Bookings YoY (Abs)', 'Revenue - TY', 'Revenue - LP', 'Revenue PoP (Abs)',
                                           'Revenue PoP (%)', 'Revenue - LY', 'Revenue YoY (%)', 'Revenue YoY (Abs)', ]]
                                       + [{'if': {'column_id': 'Spend PoP (Abs)',
                                                  'filter': 'Spend_PoP_abs_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'Spend PoP (%)',
                                                  'filter': 'Spend_PoP_percent_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'Spend YoY (%)',
                                                  'filter': 'Spend_YoY_percent_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'Sessions PoP (%)',
                                                  'filter': 'Sessions_PoP_percent_conditional < num(0)'},
                                           'color': 'red'}]
                                       + [{'if': {'column_id': 'Sessions YoY (%)',
                                                  'filter': 'Sessions_YoY_percent_conditional < num(0)'},
                                           'color': 'red'}]
                                       + [{'if': {'column_id': 'Bookings PoP (Abs)',
                                                  'filter': 'Bookings_PoP_abs_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'Bookings YoY (Abs)',
                                                  'filter': 'Bookings_YoY_abs_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'Bookings PoP (%)',
                                                  'filter': 'Bookings_PoP_percent_conditional < num(0)'},
                                           'color': 'red'}]
                                       + [{'if': {'column_id': 'Bookings YoY (%)',
                                                  'filter': 'Bookings_YoY_percent_conditional < num(0)'},
                                           'color': 'red'}]
                                       + [{'if': {'column_id': 'Revenue PoP (Abs)',
                                                  'filter': 'Revenue_PoP_abs_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'Revenue YoY (Abs)',
                                                  'filter': 'Revenue_YoY_abs_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'Revenue PoP (%)',
                                                  'filter': 'Revenue_PoP_percent_conditional < num(0)'},
                                           'color': 'red'}]
                                       + [{'if': {'column_id': 'Revenue YoY (%)',
                ...
                style_cell_conditional=[{'if': {'row_index': 'odd'}, 'backgroundColor': '#D5DBDB'}]
                                       ...
                                       + [{'if': {'column_id': c}, 'minWidth': '0px', 'maxWidth': '80px',
                                          ...
                                          ['CPS - TY', 'CPS - LP', 'CPS PoP (Abs)', 'CPS - LY', 'CPS YoY (Abs)',
                                           ...
                                           'CPA - LP', 'CPA PoP (Abs)', 'CPA - LY', 'CPA YoY (Abs)', 'CPA PoP (%)',
                                           'CPA YoY (%)']]
                                       + [{'if': {'column_id': 'CPS PoP (Abs)',
                                                  'filter': 'CPS_PoP_abs_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'CPS_PoP_abs_conditional',
                                                  'filter': 'CPS_PoP_abs_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'CPS PoP (%)',
                                                  'filter': 'CPS_PoP_percent_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'CPS YoY (Abs)',
                                                  'filter': 'CPS_YoY_abs_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'CPS YoY (%)',
                                                  'filter': 'CPS_PoP_percent_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'CVR PoP (Abs)',
                                                  'filter': 'CVR_PoP_abs_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'CVR PoP (%)',
                                                  'filter': 'CVR_PoP_percent_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'CVR YoY (Abs)',
                                                  'filter': 'CVR_YoY_abs_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'CVR YoY (%)',
                                                  'filter': 'CVR_YoY_percent_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'CPA PoP (Abs)',
                                                  'filter': 'CPA_PoP_abs_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'CPA PoP (%)',
                                                  'filter': 'CPA_PoP_percent_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'CPA YoY (Abs)',
                                                  'filter': 'CPA_YoY_abs_conditional < num(0)'}, 'color': 'red'}]
                                       + [{'if': {'column_id': 'CPA YoY (%)',
                                                  'filter': 'CPA_YoY_percent_conditional < num(0)'}, 'color': 'red'}],
                style_header={'backgroundColor': 'black', 'color': 'white'},
            ),
        ], className=" twelve columns"),
        # GRAPHS
